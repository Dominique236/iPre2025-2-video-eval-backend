  ...
  try {
    ...
    for (const c of criteriaArray) {
      const res = await client.query(
        `INSERT INTO rubric_criteria (rubric_id, idx, key, title, description, max_score) VALUES ($1,$2,$3,$4,$5,$6) RETURNING *`,
        [rubricId, c.idx || 0, c.key || null, c.title, c.description || null, c.max_score || 1]
      );
